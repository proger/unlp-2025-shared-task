...
if sys.argv[1:2] == ["mini"]:
    batch_file_path = "exp/fancy_structured_request_mini.jsonl"
    batch_result = "exp/fancy_structured_response_mini.jsonl"
    batch_id = "exp/fancy_structured_batch_id_mini"
    model_name = "gpt-4o-mini-2024-07-18"
else:
    batch_file_path = "exp/fancy_structured_request.jsonl"
    batch_result = "exp/fancy_structured_response.jsonl"
    batch_id = "exp/fancy_structured_batch_id"
